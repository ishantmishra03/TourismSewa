    ...
    <div className="bg-linear-to-br from-teal-600 via-teal-700 to-blue-700 py-20 transition-colors duration-200 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <button
          ...
          className="group inline-flex items-center gap-3 bg-white text-teal-600 hover:bg-gray-100 px-10 py-5 rounded-full text-lg font-bold transition-all duration-300 hover:scale-105 shadow-2xl"
        >
          Start Chatting Now
